...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_mask=None):
        ...
        output: the Transformer features, of shape (N, T, W)
        """
        # perform self-attention on the target sequence (along with dropout and layer norm).
...
class CaptioningTransformer(nn.Module):
    ...
    def forward(self, features, captions):
        ...
        # (4) apply the Transformer decoder to the caption, allowing it to also attend to image features.
